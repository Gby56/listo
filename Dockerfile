...
RUN cd frontend && echo "REACT_APP_TRELLO_JIRA_MODE=$REACT_APP_TRELLO_JIRA_MODE" && REACT_APP_TRELLO_JIRA_MODE=${REACT_APP_TRELLO_JIRA_MODE} REACT_APP_API_URL=/api yarn run build ; yarn run build:schema ; cd ..
